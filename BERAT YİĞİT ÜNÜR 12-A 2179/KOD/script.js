...
"Aydın": [
"Bozdoğan","Buharkent","Çine","Didim","Efeler","Germencik","İncirliova","Karacasu","Karpuzlu","Koçarlı","Köşk","Kuşadası","Kuyucak","Nazilli","Söke","Sultanhisar","Yenipazar"
],

"Balıkesir": [
"Altıeylül","Ayvalık","Balya","Bandırma","Bigadiç","Burhaniye","Dursunbey","Edremit","Erdek","Gömeç","Gönen","Havran","İvrindi","Karesi","Kepsut","Manyas","Marmara","Savaştepe","Sindirgi","Susurluk"
],
...
"Samsun": [
"Alaçam","Asarcık","Atakum","Ayvacık","Bafra","Canik","Çarşamba","Havza","İlkadım","Kavak","Ladik","Salıpazarı","Tekkeköy","Terme","Vezirköprü","Yakakent","19 Mayıs"
],

"Siirt": [
"Aydınlar (Tillo)","Baykan","Eruh","Kurtalan","Merkez","Pervari","Şirvan"
],
...
"Tokat": [
"Almus","Artova","Başçiftlik","Erbaa","Niksar","Pazar","Reşadiye","Sulusaray","Turhal","Yeşilyurt","Zile","Merkez"
],
...
if (citySelect && districtSelect) {
    ...
    citySelect.addEventListener("change", function () {
        ...
        if (!districts[city]) {
            districtSelect.innerHTML = "<option>İlçe bulunamadı</option>";
            return;
        }
